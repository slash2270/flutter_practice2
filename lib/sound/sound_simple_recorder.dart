...
class SoundSimpleRecorder extends StatefulWidget {
  const SoundSimpleRecorder({Key? key}) : super(key: key);

  @override
  _SoundSimpleRecorderState createState() => _SoundSimpleRecorderState();
}

class _SoundSimpleRecorderState extends State<SoundSimpleRecorder> {
