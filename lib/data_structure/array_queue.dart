...
class ArrayQueue {
  //創建佇列的構造函數
  ArrayQueue({required this.maxSize, required this.arr, required this.front, required this.rear});
  ...
  List<int> addQueue(int n) {
    ...
    LogUtil.e("ArrayQueue rear:$rear");
    return arr;
  }
  ...
  List<int> getQueue() {
    ...
    LogUtil.e("ArrayQueue front:$front");
    return arr;
  ...
  List<int> getHeadQueue() {
    ...
    LogUtil.e("ArrayQueue headQueue:${arr[front % arr.length]}");
    return arr;
  }
