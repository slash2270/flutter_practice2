...
// To run:
//
// flutter run -t lib/just_audio_effects_widget.dart
...
class JustAudioEffectsWidget extends StatefulWidget {
  const JustAudioEffectsWidget({Key? key}) : super(key: key);

  @override
  JustAudioEffectsWidgetState createState() => JustAudioEffectsWidgetState();
}

class JustAudioEffectsWidgetState extends State<JustAudioEffectsWidget> with WidgetsBindingObserver {
  ...
  Future<void> _init() async {
    ...
    try {
      ...
      LogUtil.e("JustAudioEffects Error loading audio source: $e");
    }
  }
