...
class JustWaveformWidget extends StatefulWidget {
  const JustWaveformWidget({Key? key}) : super(key: key);

  @override
  State<JustWaveformWidget> createState() => _JustWaveformWidgetState();
}

class _JustWaveformWidgetState extends State<JustWaveformWidget> {
