...
// import 'package:flutter_practice2/uploader/upload_item.dart';
// import 'package:flutter_practice2/uploader/upload_item_view.dart';
// import 'package:flutter_uploader/flutter_uploader.dart';
//
// /// 顯示以前上傳的狀態響應。
// class UploadResponsesScreen extends StatefulWidget {
//   const UploadResponsesScreen({
//     Key? key,
...
//
//   @override
//   _UploadResponsesScreenState createState() => _UploadResponsesScreenState();
// }
//
// class _UploadResponsesScreenState extends State<UploadResponsesScreen> {
...
//       print('IN MAIN APP: ${result.taskId}, status: ${result.status}, statusCode: ${result.statusCode}, headers: ${result.headers}');
//
//       var tmp = <String, UploadItem>{}..addAll(_tasks);
