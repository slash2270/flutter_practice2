...
// import 'package:flutter_practice2/uploader/upload_server_behavior.dart';
...
//
//   UploadServerBehavior _serverBehavior = UploadServerBehavior.defaultOk200;
//
//   @override
//   void initState() {
//     super.initState();
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Flutter Uploader Demo'),
//       ),
//       body: Padding(
...
//               children: <Widget>[
//                 Text('Configure test Server Behavior',
//                   style: Theme.of(context).textTheme.subtitle1,
//                 ),
//                 DropdownButton<UploadServerBehavior>(
//                   items: UploadServerBehavior.all.map((e) {
