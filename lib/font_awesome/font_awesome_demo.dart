...
class FontAwesomeDemo extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => FontAwesomeDemoState();
}

class FontAwesomeDemoState extends State<FontAwesomeDemo> {
  var _searchTerm = "";
  ...
  AppBar _titleBar() {
    return AppBar(
      title: const Text("ThirtyTwo Page"),
      actions: [
        IconButton(
            icon: const FaIcon(FontAwesomeIcons.glassMartiniAlt),
            onPressed: () {
