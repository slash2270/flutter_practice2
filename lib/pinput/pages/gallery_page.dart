...
class GalleryPageState extends State<GalleryPage>
  ...
  void initState() {
    super.initState();
    final otpPages = [
      const OtpPage(RoundedWithCustomCursor()),
      const OtpPage(RoundedWithShadow()),
      const OtpPage(OnlyBottomCursor()),
      const OtpPage(FilledRoundedPinPut()),
      const OtpPage(Filled()),
    ];
    pinPuts.addAll([
