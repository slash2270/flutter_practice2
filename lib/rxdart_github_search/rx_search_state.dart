...
class RxSearchLoading extends RxSearchState {}

class RxSearchError extends RxSearchState {}

class RxSearchNoTerm extends RxSearchState {}

class RxSearchPopulated extends RxSearchState {
  final RxSearchResult result;

  RxSearchPopulated(this.result);
}

class RxSearchEmpty extends RxSearchState {}