...
import 'download_bean.dart';
import 'download_list_item.dart';

class DownloadDemo extends StatefulWidget with WidgetsBindingObserver {
  DownloadDemo({Key? key, required this.platform}) : super(key: key);
...
class _DownloadDemoState extends State<DownloadDemo> {
  ...
  void _bindBackgroundIsolate() {
    ...
    _port.listen((dynamic data) {
      ...
      print(
        'DownloadDemo Callback on UI isolate: '
