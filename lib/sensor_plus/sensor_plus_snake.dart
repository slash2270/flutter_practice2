...
class SensorPlusSnake extends StatefulWidget {
  SensorPlusSnake({Key? key, this.rows = 20, this.columns = 20, this.cellSize = 10.0}) : super(key: key) {
    assert(10 <= rows);
    assert(10 <= columns);
    assert(5.0 <= cellSize);
  }
...
class SnakeState extends State<SensorPlusSnake> {
