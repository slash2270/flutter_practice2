...
class RubberDefaultPage extends StatefulWidget {
  const RubberDefaultPage({Key? key}) : super(key: key);

  @override
  _RubberDefaultPageState createState() => _RubberDefaultPageState();
}

class _RubberDefaultPageState extends State<RubberDefaultPage> with SingleTickerProviderStateMixin {
