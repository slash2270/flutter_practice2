...
class RubberAnimationPaddingPage extends StatefulWidget {
  const RubberAnimationPaddingPage({Key? key}) : super(key: key);

  @override
  _RubberAnimationPaddingPageState createState() => _RubberAnimationPaddingPageState();
}

class _RubberAnimationPaddingPageState extends State<RubberAnimationPaddingPage> with SingleTickerProviderStateMixin {
  ...
  Row option(AnimationPadding padding, String text) => Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
      ...
      body: Column(
        children: <Widget>[
          const Padding(
            ...
            child: Text(
                "在這個例子中，我們看到了一些 AnimationPadding 選項的行為。\n其他配置相同——工作表將停止在青色容器頂部和底部的 10% 邊界。"),
          ),
          option(contain,
