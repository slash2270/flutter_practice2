...
@immutable
class ColorFilterSelection extends StatefulWidget {
  const ColorFilterSelection({Key? key}) : super(key: key);

  @override
  _ColorFilterSelectionState createState() => _ColorFilterSelectionState();
}

class _ColorFilterSelectionState extends State<ColorFilterSelection> {
  final _filters = [
    Colors.white,
    ...List.generate(
