          ...
          Expanded(
            ...
            child: FittedBox(
              ...
              child: Column(
                ...
                children: <Widget>[
                  if (result != null)
                    Text('條碼類型: ${describeEnum(result!.format)} 資料: ${result!.code}')
                  else
                    const Text('掃描Code'),
                  Row(
                            ...
                            child: FutureBuilder(
                              ...
                              builder: (context, snapshot) {
                                if (snapshot.data != null) {
                                  return Text('切換鏡頭 ${describeEnum(snapshot.data!)}');
                                } else {
                                  return const Text('載入');
                                }
                              },
                            )),
                      )
  ...
  void _onPermissionSet(BuildContext context, QRViewController ctrl, bool p) {
    ...
    if (!p) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('沒權限')),
      );
    }
  }
