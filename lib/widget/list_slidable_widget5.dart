...
class ListSlidableWidget5 extends StatefulWidget {
  const ListSlidableWidget5({Key? key,}) : super(key: key);

  @override
  _ListSlidableWidget5State createState() => _ListSlidableWidget5State();
}

class _ListSlidableWidget5State extends State<ListSlidableWidget5> {
        ...
        child: Column(
          children: [
            Directionality(
              ...
              child: Padding(
                padding: _functionUtil.initEdgeInsets(16.0, 16.0, 16.0, 16.0),
                child: Slidable(
                  groupTag: '0',
                  direction: direction,
...
class AppState extends InheritedWidget {
  const AppState({Key? key, required this.direction, required Widget child,}) : super(key: key, child: child);
