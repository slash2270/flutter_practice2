...
class GZXDropDownMenuWidget extends StatefulWidget {
  const GZXDropDownMenuWidget({Key? key}) : super(key: key);
...
class _GZXDropDownMenuWidgetState extends State<GZXDropDownMenuWidget> {
  final List<String> _dropDownHeaderItemStrings = ['全城', '品牌', '距離近', '篩選'];
  ...
  void initState() {
    ...
    _brandSortConditions.add(SortCondition(name: '中影國際城我比較長，你看我選擇後是怎麼顯示的', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '星美國際城', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '博納國際城', isSelected: false));
    ...
    _brandSortConditions.add(SortCondition(name: '萬達影城', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '萬達影城1', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '萬達影城2', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '萬達影城3', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '萬達影城4', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '萬達影城5', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '萬達影城6', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '萬達影城7', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '萬達影城8', isSelected: false));
    _brandSortConditions.add(SortCondition(name: '萬達影城9', isSelected: false));
    _selectBrandSortCondition = _brandSortConditions[0];

    _distanceSortConditions.add(SortCondition(name: '距離近', isSelected: true));
    _distanceSortConditions.add(SortCondition(name: '價格低', isSelected: false));
    _distanceSortConditions.add(SortCondition(name: '價格高', isSelected: false));
          ...
          Column(
            children: <Widget>[
              Container(
                ...
                child: Text(
                  '仿美團電影下拉篩選菜單$_dropdownMenuChange',
...
//          maskColor: Colors.red.withOpacity(0.5),
            dropdownMenuChanging: (isShow, index) {
              setState(() {
                _dropdownMenuChange = '(正在${isShow ? '顯示' : '隱藏'}$index)';
                print(_dropdownMenuChange);
              });
            },
            dropdownMenuChanged: (isShow, index) {
              setState(() {
                _dropdownMenuChange = '(已經${isShow ? '顯示' : '隱藏'}$index)';
                print(_dropdownMenuChange);
              });
            },
  ...
  _buildAddressWidget(void Function(String selectValue) itemOnTap) {
//    List firstLevels = new List<int>.filled(15, 0);
    ...
    List secondLevels = List<String>.generate(15, (int index) {
      ...
      return '$_selectTempFirstLevelIndex$index街道辦';
    });
  ...
  GestureDetector gestureDetector0(int index, void Function(String selectValue) itemOnTap, item) {
    return GestureDetector(
      onTap: () {
  ...
  GestureDetector gestureDetector1(int index, void Function(String selectValue) itemOnTap, List firstLevels, item) {
    return GestureDetector(
      onTap: () {
  ...
  _buildConditionListWidget(items, void Function(SortCondition sortCondition) itemOnTap) {
