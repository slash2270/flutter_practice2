...
class AudioServicePlayList extends StatefulWidget {
  const AudioServicePlayList({Key? key}) : super(key: key);

  @override
  State<AudioServicePlayList> createState() => _AudioServicePlayListState();
}

class _AudioServicePlayListState extends State<AudioServicePlayList> {
  ...
  _init() async{
    ...
    _audioHandler = await AudioService.init(
      ...
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'com.ryanheise.myapp.channel.audio4',
...
class _MainScreenState extends State<MainScreen> {
  ...
  Stream<PositionDataC> get _positionDataStream => Rx.combineLatest3<Duration, Duration, Duration?, PositionDataC>(
          AudioService.position,
          _bufferedPositionStream,
          _durationStream,
              (position, bufferedPosition, duration) => PositionDataC(
    ...
    return SafeArea(
        child: Column(
          ...
          children: [
                ...
                builder: (context, snapshot) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      _functionUtil.initText(mediaItem.title),
                    ],
                  );
                },
              ),
            ...
            // A seek bar.
            StreamBuilder<PositionDataC>(
              stream: _positionDataStream,
              builder: (context, snapshot) {
                final positionData = snapshot.data ??
                    PositionDataC(Duration.zero, Duration.zero, Duration.zero);
                return SeekBarC(
              ...
              children: [
                StreamBuilder<AudioServiceRepeatMode>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final icons = [
                      _functionUtil.initIcon2(Icons.repeat, Colors.grey),
                      _functionUtil.initIcon2(Icons.repeat, Colors.orange),
                      _functionUtil.initIcon2(Icons.repeat_one, Colors.orange),
                    ];
                    const cycleModes = [
                        ...
                        Dismissible(
                          ...
                          child: Material(
                            color: i == queueState.queueIndex
                                ...
                                : null,
                            child: ListTile(
                              title: _functionUtil.initText(queue[i].title),
      ...
      children: [
        ...
        StreamBuilder<QueueState>(
          ...
          builder: (context, snapshot) {
            final queueState = snapshot.data ?? QueueState.empty;
            return IconButton(
              icon: _functionUtil.initIcon(Icons.skip_previous),
              onPressed:
        ...
        StreamBuilder<PlaybackState>(
          ...
          builder: (context, snapshot) {
            ...
            if (processingState == AudioProcessingState.loading ||
              ...
              return _functionUtil.initIconButton1(() => audioHandler.play, const Icon(Icons.play_arrow), 64.0,);
            } else {
              return _functionUtil.initIconButton1(() => audioHandler.pause, const Icon(Icons.pause), 64.0,);
            }
          },
        ),
        StreamBuilder<QueueState>(
          ...
          builder: (context, snapshot) {
            final queueState = snapshot.data ?? QueueState.empty;
            return _functionUtil.initIconButton1(() => queueState.hasNext ? audioHandler.skipToNext : null, const Icon(Icons.skip_next), 64.0,);
          },
        ),
